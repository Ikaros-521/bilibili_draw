...
{
	forward_num = 10000 * (parseInt(document.getElementsByClassName("text-offset")[1].innerText) + 1);
}
else
{
	forward_num = parseInt(document.getElementsByClassName("text-offset")[1].innerText);
}
